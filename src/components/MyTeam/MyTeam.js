...
//     } catch {
//       console.log("error while fetching team members");
//     }
//   };
...
//   return (
//     <Layout title={'My Team - Hype Drinks'}>
//       <div className="myTeamContainer sm:w-2/5 bg-gradient-to-b from-green-400 to-blue-400">
...
//           <h1>My Teams</h1>
//         </div>
//         <div className="memberStatus p-4 gap-4">
//           <button
...
//           </button>
//         </div>
//         <h2 className="px-4">{filterText}: {filteredTeamMembers.length}</h2>
